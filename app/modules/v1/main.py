...
from app.modules.v1.email_checker import DisposableEmailChecker

templates = Jinja2Templates(directory="app/modules/v1/templates")
...
# Routes
routes = [
    Route("/v1/check", check_email_endpoint, methods=["POST"]),
    Route("/v1/bulk-check", bulk_check_endpoint, methods=["POST"]),
    Route("/v1/stats", stats_endpoint, methods=["GET"]),
...
app.mount("/static", StaticFiles(directory="app/modules/v1/static"), name="static")
